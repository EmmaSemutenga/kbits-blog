...
from kblog.forms import RegistrationForm, LoginForm, UpdateAccountForm
from kblog.models import User, Post
from kblog import app, db, bcrypt
...
def account():
    ...
    if form.validate_on_submit():
        ...
        #to populate our form with the current user data
